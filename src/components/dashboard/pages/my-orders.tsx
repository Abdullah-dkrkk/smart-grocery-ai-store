...
import { ShoppingBag, Search, ChevronLeft, ChevronRight, AlertCircle } from "lucide-react"
...
export function MyOrders() {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-2xl font-semibold">My Orders</h2>
        <p className="text-base text-muted-foreground">Track and manage all your orders.</p>
      </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              {search || statusFilter !== "All" ? "Try adjusting your search or filter." : "You haven&apos;t placed any orders yet."}
            </p>
        ...
        <Card className="pb-0">
          <CardHeader>
            <CardTitle>
              ...
              <span className="text-sm font-normal text-muted-foreground ml-2">({filteredOrders.length})</span>
            </CardTitle>
          </CardHeader>
